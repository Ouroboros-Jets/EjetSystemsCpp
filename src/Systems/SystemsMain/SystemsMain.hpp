/*
 * This File serves as the entry point to the systems running in a single threaded environment. The use of the debug GUI
 * simply causes too much clutter to put in with the main thread
 */
...
inline void SystemMain() {
    auto HydraulicState = Variables::Hydraulic::HydraulicVars{.System1 = Variables::Hydraulic::System1Vars{.ReservoirLevel = 0.0f,
